 ...
 * @author maged
 */
@WebServlet(name = "ReturnMovieController", urlPatterns = {"/ReturnMovieController"})
public class ReturnMovieController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(rentcheck2!=null){
            rent.returnMovie(movie_id,userid);
            movie mov=new movie();
            mov.updateRentCount(movie_id,-1);}
            //rent.returnMovie2(movie_id,1);
